...
[RELEASE NOTES](https://github.com/BEXIS2/Core/blob/2.14/Release%20Notes/Release_Notes.md)
...
[CHANGES](https://github.com/BEXIS2/Core/blob/2.14/Release%20Notes/changes.md)

>if a running instance is updated, an update to the database is required.

- STEP BY STEP

[UPDATE SCRIPTS](https://github.com/BEXIS2/Core/blob/2.14/database%20update%20scripts)
