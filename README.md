...
[RELEASE NOTES](https://github.com/BEXIS2/Core/blob/3.1.0/Release%20Notes/Release_Notes.md)
...
[CHANGES](https://github.com/BEXIS2/Core/blob/3.1.0/Release%20Notes/changes.md)

>if a running instance is updated, an update to the database is required.

- STEP BY STEP

[UPDATE SCRIPTS](https://github.com/BEXIS2/Core/blob/3.1.0/database%20update%20scripts)

# Installation

For the preparation of Bexis 2 on a server a guide is available here.

[Installation Manual](https://github.com/BEXIS2/Documents/blob/3.1.0/Guides/Installation/installation.md)
...
- [Workspace 3.1.0 Repo](https://github.com/BEXIS2/Workspace/tree/3.1.0)
- [Workspace 3.1.0 Release](https://github.com/BEXIS2/Workspace/releases/tag/3.1.0)

# List of new Modules

- [Modules Overview](https://github.com/BEXIS2/Core/blob/3.1.0/MODULES.md)
