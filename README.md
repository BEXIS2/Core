...
[RELEASE NOTES](https://github.com/BEXIS2/Core/blob/3.3.3/Release%20Notes/Release_Notes.md)
...
[CHANGES](https://github.com/BEXIS2/Core/blob/3.3.3/Release%20Notes/changes.md)

>if a running instance is updated, an update to the database is required.

- STEP BY STEP

[UPDATE SCRIPTS](https://github.com/BEXIS2/Core/blob/3.3.3/database%20update%20scripts)

# Installation

For the preparation of Bexis 2 on a server a guide is available here.

[Installation Manual](https://github.com/BEXIS2/Documents/blob/3.3.3/Guides/Installation/installation.md)
...
- [Workspace 3.3.3 Repo](https://github.com/BEXIS2/Workspace/tree/3.3.3)
- [Workspace 3.3.3 Release](https://github.com/BEXIS2/Workspace/releases/tag/3.3.3)

# List of new Modules

- [Modules Overview](https://github.com/BEXIS2/Core/blob/3.3.3/MODULES.md)
