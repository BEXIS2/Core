...
[RELEASE NOTES](https://github.com/BEXIS2/Core/blob/2.17/Release%20Notes/Release_Notes.md)
...
[CHANGES](https://github.com/BEXIS2/Core/blob/2.17/Release%20Notes/changes.md)

>if a running instance is updated, an update to the database is required.

- STEP BY STEP

[UPDATE SCRIPTS](https://github.com/BEXIS2/Core/blob/2.17/database%20update%20scripts)

# Installation

For the preparation of Bexis 2 on a server a guide is available here.

[Installation Manual](https://github.com/BEXIS2/Documents/blob/2.17/Guides/Installation/installation.md)
...
- [Workspace 2.17 Repo](https://github.com/BEXIS2/Workspace/tree/2.17)
- [Workspace 2.17 Release](https://github.com/BEXIS2/Workspace/releases/tag/2.17)

# List of new Modules

- [Modules Overview](https://github.com/BEXIS2/Core/blob/2.17/MODULES.md)
