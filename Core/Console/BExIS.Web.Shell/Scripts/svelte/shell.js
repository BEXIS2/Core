...
var app = (function () {
    ...
    var dataTables_dataTables = createCommonjsModule(function (module, exports) {
    (function( factory ){
    	{
    		// CommonJS
    		module.exports = function (root, $) {
    ...
    /* src\tests\DataTablesServerSide.svelte generated by Svelte v3.42.1 */
    const file = "src\\tests\\DataTablesServerSide.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(link, "href", "//cdn.datatables.net/1.10.21/css/jquery.dataTables.min.css");
    			add_location(link, file, 27, 1, 518);
    			add_location(th0, file, 33, 5, 712);
    			add_location(th1, file, 34, 5, 730);
    			add_location(th2, file, 35, 5, 750);
    			add_location(tr0, file, 32, 3, 701);
    			add_location(thead, file, 31, 1, 689);
    			add_location(th3, file, 41, 4, 813);
    			add_location(th4, file, 42, 4, 830);
    			add_location(th5, file, 43, 4, 849);
    			add_location(tr1, file, 40, 3, 803);
    			add_location(tfoot, file, 39, 1, 791);
    			attr_dev(table, "class", "display");
    			set_style(table, "width", "100%");
    			add_location(table, file, 30, 0, 629);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	validate_slots('DataTablesServerSide', slots, []);
    	...
    	onMount(() => {
    		jquery(el).DataTable({
    			serverSide: true,
    			ajax: { "url": "/UiTest/Load", "type": "POST" },
    			columns: [
    				{ data: 'Id', Name: "Id" },
    				{ data: 'Name', Name: "Name" },
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<DataTablesServerSide> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ jQuery: jquery, onMount, initDt: dataTables_dataTables, el });
    ...
    class DataTablesServerSide extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment(ctx) {
    	let dt;
    	let current;
    	dt = new DataTablesServerSide({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(dt.$$.fragment);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			mount_component(dt, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(dt.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(dt.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(dt, detaching);
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ DT: DataTablesServerSide });
    	return [];
    }
