...
namespace BExIS.Dlm.Services.Meanings
{
    public interface ImeaningManagr : IDisposable
    {
        ...
        Meaning addMeaning(string Name, String ShortName, String Description, Selectable selectable, Approved approved,  List<string> externalLink, List<string> meaning_ids);
        Boolean deleteMeaning(Meaning meaning);
        List<Meaning> deleteMeaning(Int64 id);
        Meaning editMeaning(Meaning meaning);
        Meaning editMeaning(string id, string Name, String ShortName, String Description, Selectable selectable, Approved approved, List<string> externalLink, List<string> meaning_ids);
