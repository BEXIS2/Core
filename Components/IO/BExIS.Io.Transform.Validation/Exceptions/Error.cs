...
namespace BExIS.IO.Transform.Validation.Exceptions
{
    ...
    public class Warning
    {
        ...
        /// <param name="errorType"></param>
        /// <param name="issue"></param>
        public Warning(ErrorType errorType, string issue)
        {
            _issue = issue;
            _errorType = errorType;
        }
        ...
        /// <param name="issue"></param>
        /// <param name="name"></param>
        public Warning(ErrorType errorType, string issue, string name)
        {
            _name = name;
            _issue = issue;
            _errorType = errorType;
        ...
        /// MetadataAttribute: (0=name, 1=value, 2=attributeNumber, 3= packageNumber)
        /// </param>
        public Warning(ErrorType errorType, string issue, params object[] valueList)
        {
            _errorType = errorType;
            _issue = issue;
    ...
    /// <summary>
    /// type of propblems in data, for errors and warnings
    /// it describes a area like in value or in datastrutcure
    /// </summary>
