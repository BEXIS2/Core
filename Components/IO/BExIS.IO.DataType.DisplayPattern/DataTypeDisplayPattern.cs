...
namespace BExIS.IO.DataType.DisplayPattern
{
    public class DataTypeDisplayPattern
    {
        private static List<DataTypeDisplayPattern> displayPatterns = new List<DataTypeDisplayPattern>()
        {
            ...
            new DataTypeDisplayPattern() {Id=24, Systemtype = DataTypeCode.DateTime,   Name = "DateTimeIso without T",       ExcelPattern=@"yyyy-MM-dd hh:mm:ss tt", DisplayPattern = "yyyy-MM-dd hh:mm:ss tt",     StringPattern = "yyyy-MM-dd HH:mm:ss tt",      RegexPattern = null},
            new DataTypeDisplayPattern() {Id=25,Systemtype = DataTypeCode.DateTime,   Name = "DateEu with time",            ExcelPattern=@"dd\.MM\.yyyy hh:mm:ss tt",          DisplayPattern="dd.MM.yyyy hh:mm:ss tt",                StringPattern = "dd.MM.yyyy hh:mm:ss tt",              RegexPattern = null},
