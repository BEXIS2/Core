...
var app = (function () {
    ...
    /* src\uitest\Index.svelte generated by Svelte v3.42.1 */

    const file = "src\\uitest\\Index.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Ui Test Index";
    			add_location(h1, file, 4, 0, 25);
    		},
    ...
    const app = new Index({
    	target: document.getElementById('uitest')
    });
