    ...
    */
    ...
    function create_default_slot_3$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(46:6) <DropdownToggle nav>",
    		ctx
    	});
    ...
    // (49:10) {#if isNewModule(item.Module) }
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(hr, file$1, 48, 45, 884);
    			add_location(li, file$1, 48, 41, 880);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, hr);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(49:10) {#if isNewModule(item.Module) }",
    		ctx
    	});
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", a_href_value = /*item*/ ctx[5].Url);
    			attr_dev(a, "target", a_target_value = /*item*/ ctx[5].Target);
    			add_location(a, file$1, 49, 24, 949);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    ...
    // (47:6) <DropdownMenu style="{menuStyle}">
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(47:6) <DropdownMenu style=\\\"{menuStyle}\\\">",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(45:4) <Dropdown nav inNavbar>",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<SettingsBar> was created with unknown prop '${key}'`);
    	});
    ...
    class SettingsBar extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*bar*/ ctx[0] === undefined && !('bar' in props)) {
    			console.warn("<SettingsBar> was created without expected prop 'bar'");
    		}

    		if (/*menuStyle*/ ctx[1] === undefined && !('menuStyle' in props)) {
    			console.warn("<SettingsBar> was created without expected prop 'menuStyle'");
    		}
    	}
