                    ...
                    transport: {
                        ...
                        read: {
                            ...
                            dataFilter: function (v, w) {
                                ...
                                // temporary fix for dates of year 1 (add 1900 years), which can not be converted back in JavaScript (time shift of 7minutes)
                                v = eval("(" + v.replace(j, function (_, m) { if (parseInt(m) < -61135551800000) { m = parseInt(m) + 59918400000000; console.log(m); } return "new Date(" + parseInt(m) + ")" }) + ")");
                                u._onComplete({
                                    name: "dataBinding",
                                    response: v
                                });
