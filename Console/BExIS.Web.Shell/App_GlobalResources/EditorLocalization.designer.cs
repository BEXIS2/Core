...
//
//     Changes to this FileStream may cause incorrect behavior and will be lost if
...
namespace Resources
{
    ...
    // To add or remove a member, edit your .ResX FileStream then rerun ResGen
    ...
    internal class EditorLocalization {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The selected FileStream {0} is not valid. Supported FileStream types are {1}..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to A FileStream with name {0} already exists in the current directory. Do you want to overwrite it?.
        /// </summary>
