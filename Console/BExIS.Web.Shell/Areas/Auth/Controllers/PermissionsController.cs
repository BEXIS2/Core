...
namespace BExIS.Web.Shell.Areas.Auth.Controllers
{
    public class PermissionsController : Controller
    {
        ...
        public int CreateFeaturePermission(long featureId, long subjectId)
        {
            ...
            return permissionManager.CreateFeaturePermission(featureId, subjectId);
        }

        public int DeleteFeaturePermission(long featureId, long subjectId)
        {
            PermissionManager permissionManager = new PermissionManager();

            return permissionManager.DeleteFeaturePermissionByFeatureAndSubject(featureId, subjectId);
        }
        ...
        public int DeleteDataPermission(long dataId, string entityId, long subjectId, int rightType)
        {
            ...
            return permissionManager.DeleteDataPermission(dataId, entityId, subjectId, (RightType)rightType);
        }
