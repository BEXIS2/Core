...
import { CurationClass, CurationFilterType, type CurationFilterModel } from '$lib/models/Curation';
import {
	CurationEntryClass,
	CurationEntryStatus,
...
import { CurationStatusEntryTab } from '$lib/models/CurationStatusEntry';
import {
	getCurationDataset,
	postCurationEntry,
	putCurationEntry
...
class CurationStore {
	...
	private readonly _entryCardStates = new Map<
		...
		Writable<{
			...
			inputData: CurationEntryCreationModel | undefined;
		}>
	>();
