import type { CurationModel } from '$lib/models/Curation';
import type { CurationEntryModel } from '$lib/models/CurationEntry';
import type { CurationsOverviewModel } from '$lib/models/CurationsTable';
