<script lang="ts">
	...
	import TableLabelFilter from './table/TableLabelFilter.svelte';
	import TableLabelCell from './table/TableLabelCell.svelte';
	import TableStatusFilter from './table/TableStatusFilter.svelte';
	import TableOptions from './table/TableOptions.svelte';
	import { goto } from '$app/navigation';
	import SpinnerOverlay from '$lib/components/SpinnerOverlay.svelte';
	import { overviewStore } from '$lib/stores/CurationOverviewStore';
	import {
