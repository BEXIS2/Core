<script lang="ts">
	...
	import CurationDatasetInfo from './details/utils/CurationDatasetInfo.svelte';
	import StartCuration from './details/utils/StartCuration.svelte';
	import CurationStatusEntryCard from './details/statusEntry/CurationStatusEntryCard.svelte';
