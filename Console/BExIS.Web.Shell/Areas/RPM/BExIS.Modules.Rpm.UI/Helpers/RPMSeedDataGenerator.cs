        ...
        public void GenerateSeedData()
        {
            ...
            try
            {
                ...
                using (MeaningManager _meaningManager = new MeaningManager())
                {
                    ...
                    _meaningManager.addMeaning("Example 1 name", "Example 1 ShortName", "Example 1 description", Selectable.yes, Approved.yes, new List<string> { }, new List<string> { });
                    _meaningManager.addMeaning("Example 2 name", "Example 2 ShortName", "Example 2 description", Selectable.yes, Approved.yes, new List<string> { }, new List<string> { });
                    _meaningManager.addMeaning("Example 3 name", "Example 3 ShortName", "Example 3 description", Selectable.yes, Approved.yes, new List<string> { }, new List<string> { });
                }
