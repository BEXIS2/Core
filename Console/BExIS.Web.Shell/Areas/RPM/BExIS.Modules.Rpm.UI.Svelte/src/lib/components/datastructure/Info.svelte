...
<div class="card m-5 p-5 w-1/2">
  ...
  <h3 class="h3">Please wait.</h3>
  <div class="p-5">
    <p>We are currently taking samples and analyzing your file to suggest data types, date patterns, and existing variable meanings.</p>
