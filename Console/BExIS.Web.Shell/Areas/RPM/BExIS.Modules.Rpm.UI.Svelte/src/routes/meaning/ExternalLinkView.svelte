...
<div id={'' + index} class="flex space-x-3 items-center">
	<TextInput id="link_name" bind:value={link.name} on:change placeholder="Name" disabled={true} />

	<TextInput id="link_type" bind:value={link.type} on:change placeholder="Type" disabled={true} />

	<TextInput id="link_uri" bind:value={link.uri} on:change placeholder="Uri" disabled={true} />
