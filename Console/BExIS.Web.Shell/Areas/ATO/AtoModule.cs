using BExIS.Modules.Ato.UI.Helpers;
using System;
using Vaiona.Logging;
using Vaiona.Web.Mvc.Modularity;

namespace BExIS.Modules.Ato.UI
{
    public class AtoModule : ModuleBase
    {
        public AtoModule() : base("ato")
        {
            LoggerFactory.GetFileLogger().LogCustom("...ctor of ato...");
        }
        public override void Install()
        {
            LoggerFactory.GetFileLogger().LogCustom("...start install of ato...");
            try
            {
                base.Install();
                using (ATOSeedDataGenerator generator = new ATOSeedDataGenerator())
                {
            ...
            LoggerFactory.GetFileLogger().LogCustom("...end install of ato...");
