...
<div class="flex w-full mb-1">
	{#if type == 'uri'}
		<div
			class="shadow w-11 border border-gray-300 rounded-l px-2 py-1"
			class:bg-success-300={dataset.URIHealth === 'yes' || dataset.URIHealth === 'true'}
			class:bg-error-300={dataset.URIHealth === 'no' ||
				dataset.URIHealth === 'false' ||
				dataset.URIHealth === 'no data made available online'}
			class:bg-surface-300={dataset.URIHealth !== 'yes' &&
				dataset.URIHealth !== 'true' &&
				dataset.URIHealth !== 'no' &&
				dataset.URIHealth !== 'false' &&
				dataset.URIHealth !== 'no data made available online'}
		>
		...
		<div
			class="line-clamp-1 shadow bg-surface-200 border-t border-b border-r border-gray-200 rounded-r px-2 py-1"
		>
			<a
				href={dataset.URI}
				target="_blank"
	...
	{:else if type == 'doi'}
		<div
			...
			class:bg-error-300={dataset.DOIHealth === 'no' ||
				dataset.DOIHealth === 'false' ||
				dataset.DOIHealth === 'no data made available online'}
			class:bg-surface-300={dataset.DOIHealth !== 'yes' &&
				dataset.DOIHealth !== 'true' &&
				dataset.DOIHealth !== 'no' &&
				dataset.DOIHealth !== 'false' &&
				dataset.DOIHealth !== 'no data made available online'}
		>
