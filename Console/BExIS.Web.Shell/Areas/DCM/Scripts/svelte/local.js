...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			b = element("b");
    			t = text(t_value);
    			add_location(b, file$1, 38, 2, 931);
    			attr_dev(div, "class", div_class_value = "mb-3 hook-status-" + /*status*/ ctx[0] + " hook" + " svelte-1lxw4ll");
    			add_location(div, file$1, 37, 1, 883);
    			attr_dev(a, "href", /*url*/ ctx[3]);
    			set_style(a, "text-decoration", "none");
    			attr_dev(a, "class", "svelte-1lxw4ll");
    			add_location(a, file$1, 36, 0, 835);
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*status*/ 1 && div_class_value !== (div_class_value = "mb-3 hook-status-" + /*status*/ ctx[0] + " hook" + " svelte-1lxw4ll")) {
    ...
    function create_fragment$1(ctx) {
    	let if_block_anchor;
    	let if_block = /*isEnabled*/ ctx[2] && create_if_block(ctx);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['id', 'version', 'status', 'name', 'displayName', 'start'];
    	...
    	return [status, displayName, isEnabled, url, id, version, name, start];
    }
    ...
    class Hook extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*name*/ ctx[6] === undefined && !('name' in props)) {
    			console.warn("<Hook> was created without expected prop 'name'");
    		}
    ...
    /* src\pages\Local.svelte generated by Svelte v3.44.1 */
    const file = "src\\pages\\Local.svelte";
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Local', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Local> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ Hook });
    	return [];
    }

    class Local extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
