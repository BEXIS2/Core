...
var app = (function () {
    ...
    /* src\pages\views\ResultMessages.svelte generated by Svelte v3.44.1 */

    const { console: console_1 } = globals;
    const file = "src\\pages\\views\\ResultMessages.svelte";
    ...
    // (33:0) {#each messages as message}
    function create_each_block(ctx) {
    	let b;
    	let t_value = /*message*/ ctx[2].timestamp + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*messages*/ 1 && t_value !== (t_value = /*message*/ ctx[2].timestamp + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(33:0) {#each messages as message}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	let messages;
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('ResultMessages', slots, []);
    	...
    	onMount(async () => {
    		...
    		const url = hosturl + 'dcm/edit/loadResultMessages?id=' + id;
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<ResultMessages> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ onMount, hosturl, Spinner, id, messages });
    ...
    class ResultMessages extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
