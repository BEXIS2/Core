...
var app = (function () {
    ...
    // (39:6) {#each message.messages as messagepart}
    function create_each_block_1(ctx) {
    	let t_value = /*messagepart*/ ctx[5] + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*messages*/ 1 && t_value !== (t_value = /*messagepart*/ ctx[5] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(t);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(39:6) {#each message.messages as messagepart}",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	let b;
    	let t0_value = /*message*/ ctx[2].timestamp + "";
    	let t0;
    	let t1;
    	let br;
    	let t2;
    	let t3;
    	let each_value_1 = /*message*/ ctx[2].messages;
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			add_location(b, file, 36, 6, 751);
    			add_location(br, file, 36, 33, 778);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*messages*/ 1 && t0_value !== (t0_value = /*message*/ ctx[2].timestamp + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*messages*/ 1) {
    				each_value_1 = /*message*/ ctx[2].messages;
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(34:3) {#each messages as message}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let id = 1; //container.getAttribute("dataset");
    	console.log("in resultmessages");
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Messages> was created with unknown prop '${key}'`);
    	});
