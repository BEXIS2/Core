...
var app = (function () {
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$b, 60, 0, 1427);
    		},
    ...
    const file$2 = "src\\components\\view\\Header.svelte";
    ...
    function create_default_slot_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(/*title*/ ctx[2]);
    			add_location(h1, file$2, 12, 4, 218);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b, file$2, 23, 4, 412);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b, file$2, 26, 3, 486);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, b, anchor);
    		},
    ...
    class Header extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { id: 0, version: 1, title: 2 });
    ...
    const file$1 = "src\\components\\view\\Tab.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 35, 1, 694);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 30, 1, 565);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    // (29:0) <TabPane id="{name}" tabId="{name}" tab={name.toUpperCase()} {active}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(29:0) <TabPane id=\\\"{name}\\\" tabId=\\\"{name}\\\" tab={name.toUpperCase()} {active}>",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*name*/ 1) tabpane_changes.tab = /*name*/ ctx[0].toUpperCase();
    			if (dirty & /*active*/ 2) tabpane_changes.active = /*active*/ ctx[1];

    			if (dirty & /*$$scope, content*/ 68) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['name', 'id', 'version', 'start', 'active'];
    	...
    	return [name, active, content, id, version, start];
    }
    ...
    function create_if_block_1(ctx) {
    	...
    	tabcontent.$on("click", /*click_handler*/ ctx[6]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 63, 0, 1329);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, hooks, version*/ 262156) {
    ...
    function create_each_block_1(ctx) {
    	...
    	tab = new Tab({
    			props: {
    				id: /*id*/ ctx[4],
    				version: /*version*/ ctx[2],
    				start: /*hook*/ ctx[15].Start,
    				name: /*hook*/ ctx[15].Name,
    				active: /*i*/ ctx[17] == 0
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const tab_changes = {};
    			if (dirty & /*version*/ 4) tab_changes.version = /*version*/ ctx[2];
    			if (dirty & /*hooks*/ 8) tab_changes.start = /*hook*/ ctx[15].Start;
    			if (dirty & /*hooks*/ 8) tab_changes.name = /*hook*/ ctx[15].Name;
    			tab.$set(tab_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(67:2) {#each hooks as hook,i}",
    		ctx
    	});
    ...
    // (66:1) <TabContent {activeTab} on:click={() => alert("clicked")}>
    function create_default_slot_1(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value_1 = /*hooks*/ ctx[3];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*id, version, hooks*/ 28) {
    				each_value_1 = /*hooks*/ ctx[3];
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(66:1) <TabContent {activeTab} on:click={() => alert(\\\"clicked\\\")}>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(hr, file, 80, 0, 1699);
    			add_location(b, file, 81, 0, 1705);
    		},
    		m: function mount(target, anchor) {
    ...
    // (83:0) {#each hooks as h}
    function create_each_block(ctx) {
    	let p;
    	let t0_value = /*h*/ ctx[12].Name + "";
    	let t0;
    	let t1;
    	let t2_value = /*h*/ ctx[12].Status + "";
    	let t2;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*hooks*/ 8 && t0_value !== (t0_value = /*h*/ ctx[12].Name + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*hooks*/ 8 && t2_value !== (t2_value = /*h*/ ctx[12].Status + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_default_slot(ctx) {
    	...
    	let if_block0 = /*hooks*/ ctx[3] && create_if_block_1(ctx);
    	let if_block1 = /*hooks*/ ctx[3] && /*visible*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 75, 1, 1592);
    			add_location(label, file, 74, 0, 1582);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*version*/ 4) header_changes.version = /*version*/ ctx[2];
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, hooks, visible, version, title*/ 262159) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		$$invalidate(3, hooks = model.Hooks);
    		$$invalidate(0, title = model.Title);
    		$$invalidate(2, version = model.Version);
    	...
    	$$invalidate(2, version = container.getAttribute("version"));
    	$$invalidate(3, hooks = null);
