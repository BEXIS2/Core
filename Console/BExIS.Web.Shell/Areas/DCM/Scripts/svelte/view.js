...
var app = (function () {
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file$9, 71, 0, 1672);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t = text(/*title*/ ctx[2]);
    			add_location(h1, file$2, 11, 4, 194);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(11:2) <Col class=\\\"col-sm-12\\\">",
    		ctx
    	});
    ...
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(16:2) <Col class=\\\"col-sm-1\\\">",
    		ctx
    	});
    ...
    function create_default_slot_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(19:2) <Col class=\\\"col-sm-1\\\">",
    		ctx
    	});
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b, file$2, 22, 4, 388);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(22:2) <Col class=\\\"col-sm-5\\\">",
    		ctx
    	});
    ...
    // (25:2) <Col class="col-sm-5 text-end">
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b, file$2, 25, 3, 462);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, b, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(25:2) <Col class=\\\"col-sm-5 text-end\\\">",
    		ctx
    	});
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Row, Col, Label, id, version, title });
    ...
    // (26:0) <TabPane id="{name}" tabId="{name}" tab={name} >
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			add_location(p, file$1, 27, 1, 495);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(26:0) <TabPane id=\\\"{name}\\\" tabId=\\\"{name}\\\" tab={name} >",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*name*/ 1) tabpane_changes.tab = /*name*/ ctx[0];

    			if (dirty & /*$$scope, content*/ 34) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		$$invalidate(1, content = await res.text());
    	});

    	const writable_props = ['name', 'id', 'version', 'start'];
    	...
    	return [name, content, id, version, start];
    }

    class Tab extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { name: 0, id: 2, version: 3, start: 4 });
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(64:2) {#each hooks as hook}",
    		ctx
    	});
    ...
    // (63:1) <TabContent {activeTab} on:click={() => alert("clicked")}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(63:1) <TabContent {activeTab} on:click={() => alert(\\\"clicked\\\")}>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(hr, file, 78, 0, 1618);
    			add_location(b, file, 79, 0, 1624);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 73, 1, 1511);
    			add_location(label, file, 72, 0, 1501);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
