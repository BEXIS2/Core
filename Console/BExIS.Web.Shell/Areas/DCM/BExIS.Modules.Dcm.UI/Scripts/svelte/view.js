...
var app = (function () {
    ...
    const getViewStart = async (action, id, version) => {
      try {
        const url = action+'?id='+id+'&version='+version;
        const response = await Api.get(url);
        return response;
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (default_slot) default_slot.c();
    			set_attributes(div, div_data);
    			add_location(div, file$7, 40, 0, 1012);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (default_slot) default_slot.c();
    			set_attributes(div, div_data);
    			add_location(div, file$4, 36, 2, 914);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    /* src\components\view\Header.svelte generated by Svelte v3.46.4 */
    ...
    /* src\components\view\Tab.svelte generated by Svelte v3.46.4 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 39, 1, 701);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 34, 1, 572);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    // (33:0) <TabPane id="{name}" tabId="{name}" tab={displayName.toUpperCase()} {active}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(33:0) <TabPane id=\\\"{name}\\\" tabId=\\\"{name}\\\" tab={displayName.toUpperCase()} {active}>",
    		ctx
    	});
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		console.log(name);
    		$$invalidate(3, content = await getHookStart(start, id, version));
    	});
    ...
    /* src\pages\View.svelte generated by Svelte v3.46.4 */
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 56, 0, 1208);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(60:2) {#each hooks as hook,i}",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(59:1) <TabContent {activeTab} >",
    		ctx
    	});
