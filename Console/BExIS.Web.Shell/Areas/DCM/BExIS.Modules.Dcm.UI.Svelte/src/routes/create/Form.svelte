...
{#if titleField}
  <InputEntry label={titleField.name} required={true} type={titleField.type} bind:value={titleField.value}
...
{/if}
{#if descriptionField}
  <InputEntry label={descriptionField.name} type="Text" required={true} bind:value={descriptionField.value}
