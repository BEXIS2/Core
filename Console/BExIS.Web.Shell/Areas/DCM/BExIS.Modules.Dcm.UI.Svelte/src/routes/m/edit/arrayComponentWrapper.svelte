<script lang="ts">
	...
	import { setValueByPath, updateMetadataStore, schemaToJson, toggleShow, getNodeByPath, isActive, setActive, setInactive, getPartyIdByPath } from '$lib/components/utils/metadata/metadataComponentUtils';
