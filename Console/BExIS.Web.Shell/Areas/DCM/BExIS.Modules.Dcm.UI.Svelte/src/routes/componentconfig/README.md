...
To restore state, manually move downloaded files to `src/routes/componentconfig/Downloads/` (filename supports numbered duplicates like `(1)`)
...
### Metadata Schema
Current local load from `src/routes/componentconfig/Schema/` (e.g. `metadataSchema_x.json`)
